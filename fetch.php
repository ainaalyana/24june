    ...
    <div class="container-fluid">
        ...
        <table class="table table-striped table-bordered">
            <tr style="text-align:center;">
             ...
             <?php
             $slct = "select * from user_data_final_table";
             $slct2 = mysqli_query($connection, $slct);
             while($data2=mysqli_fetch_array($slct2)){
                 ?>
                    <tr style="text-align:center">
                        ...
                        <td><a href="delete.php" class="btn btn-danger" type="button">DELETE</a></td>
                        <td><a href="update.php" class="btn btn-success" type="button">UPDATE</a></td>
                    </tr>
                 <?php
             }
             ?>
